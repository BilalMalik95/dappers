                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px sorting" style="width: 135.562px;">Title</th>
                                    <th class="min-w-125px sorting" style="width: 169.766px;">Slug</th>
                                    <th class="min-w-125px sorting" style="width: 149.844px;">Image</th>
                                    <th class="min-w-125px sorting" style="width: 176.078px;">Created Date</th>
                                    <th class="text-end min-w-70px sorting_disabled" style="width: 105.797px;">Actions </th>
                                </tr>
                            </thead>
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr class="odd">
                                    ...
                                    <td>{{ $category->slug }}</td>
                                    <td>
                                        <img src="{{ asset('frontend/assets/images/'.$category->image) }}" alt="{{ $category->name }}" class="img-fluid rounded" style="max-width: 100px;">
                                    </td>
                                    <td>{{ $category->created_at }}</td>

                                    <td class="text-end">
                                        <a data-action="{{ route('admin.categories.edit') }}" data-id="{{ $category->id }}" href="javascript:;" class="btn editCategory btn-primary btn-sm  p-1">
                                        ...
                                        <a href="{{ route('admin.categories.destroy', $category->id) }}" onclick="return confirm('Are you sure you want to delete this category?')" class="btn btn-danger btn-sm p-1">
                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
