...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_user_modal">Add User</button>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px sorting" style="width: 169.766px;">Email</th>
                                    <th class="min-w-125px sorting" style="width: 149.844px;">Role</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="text-end">
                                        <a data-action="{{ route('admin.users.edit') }}" data-id="{{ $user->id }}" href="javascript:;" class="btn editUser btn-primary btn-sm  p-1">
                                        ...
                                        <a href="{{ route('admin.users.destroy', $user->id) }}" onclick="return confirm('Are you sure you want to delete this user?')" class="btn btn-danger btn-sm p-1">
                                            <?xml version="1.0" encoding="UTF-8"?>
                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        @include('admin.users.models.add_user_model');
        @include('admin.users.models.update_user_model');
            ...
            $.ajax({
                ...
                , success: function(response) {
                    if (response.data) {
                        ...
                        $('#EditUserForm #editUserName').val(data.name);
                        $('#EditUserForm #editUserEmail').val(data.email);
                        $('#EditUserForm #editUserRole').html('');
                        $('#EditUserForm #editUserRole').append(selectOptions);
                        $('#EditUserForm #id').val(data.id);
