...
<head>
   ...
   ======================================== */
        .stats {
            padding: 100px 0;
            background:
                radial-gradient(circle at 15% 20%, rgba(239, 68, 68, 0.08), transparent 38%),
                radial-gradient(circle at 85% 30%, rgba(249, 115, 22, 0.08), transparent 42%),
                var(--bg-dark-alt);
        }
        ...
        .stat-card {
            ...
            border-radius: 22px;
            background: linear-gradient(165deg, rgba(29, 29, 42, 0.95) 0%, rgba(20, 20, 31, 0.95) 100%);
            text-align: center;
        ...
        .stat-number {
            ...
            font-weight: 900;
            background: linear-gradient(135deg, #ff5a5a 15%, #ff7a45 85%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            margin-bottom: 14px;
            line-height: 1;
        ...
        <div class="container">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <span class="stats-subtext">Measured across recent client launches</span>
                </div>
                <div class="stat-card">
                    <div class="stat-icon">
                    ...
                    <span class="stats-subtext">Optimized for mobile and desktop users</span>
                </div>
                <div class="stat-card">
                    <div class="stat-icon">
                    ...
                    <span class="stats-subtext">Built through long-term performance gains</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <form id="auditForm" action="{{ route('lead.store') }}" method="POST" class="audit-form">
                ...
                <div class="recaptcha-wrap">
                    ...
                    <div id="captchaError" style="color:#ef4444; display:none;">
