...
<head>
   ...
   ======================================== */
        * {
        ...
        :root {
            ...
            --surface-glow: rgba(239, 68, 68, 0.16);
            --section-glow: rgba(249, 115, 22, 0.09);
        ...
        body {
            ...
            background:
                radial-gradient(circle at 15% 12%, var(--section-glow), transparent 34%),
                radial-gradient(circle at 85% 8%, rgba(239, 68, 68, 0.1), transparent 32%),
                var(--bg-dark);
   ...
   ======================================== */
        ...
        .hero {
            ...
            text-align: center;
            overflow: hidden;
            background: linear-gradient(180deg, rgba(23, 23, 36, 0.2) 0%, rgba(9, 9, 15, 0.72) 100%);
        }
        ...
        .hero::before {
            ...
            width: 760px;
            height: 760px;
            background: radial-gradient(circle, rgba(239, 68, 68, 0.14) 0%, rgba(239, 68, 68, 0) 66%);
            pointer-events: none;
            z-index: 0;
        }
   ...
   ======================================== */
        ...
        .testimonial-card {
            background: linear-gradient(180deg, rgba(30, 31, 46, 0.95), rgba(20, 21, 33, 0.95));
            padding: 20px;
            border-radius: 16px;
   ...
   ======================================== */
        ...
        .service-card {
            background: linear-gradient(180deg, rgba(27, 28, 42, 0.95) 0%, rgba(22, 23, 35, 0.95) 100%);
            padding: 40px;
            border-radius: 18px;
            border: 1px solid var(--border-color);
            transition: all 0.3s ease;
   ...
   ======================================== */
        ...
        .stat-card {
            padding: 18px 16px;
            border-radius: 24px;
            background: linear-gradient(160deg, #1f2232 0%, #171926 100%);
            text-align: center;
   ...
   ======================================== */
        ...
        /* .process-card {
            ...
            flex-direction: column;
            align-items: center;
            background: linear-gradient(180deg, rgba(24, 25, 38, 0.95), rgba(18, 19, 30, 0.95));
            padding: 20px 10px;
            border-radius: 16px;
            border: 1px solid var(--border-color);
            min-height: 280px;
   ...
   ======================================== */
        ...
        .audit-form {
            max-width: 800px;
            margin: 0 auto;
            background: linear-gradient(180deg, rgba(25, 26, 39, 0.98), rgba(18, 19, 29, 0.98));
            padding: 48px;
            border-radius: 16px;
            border: 1px solid var(--border-color);
            box-shadow: var(--shadow-strong);
...
<body>
        ...
        <div class="container">
            <div class="nav-content">
                ...
                <div class="nav-right">
                    ...
                    <a href="#form" class="btn btn-primary">Get Free Audit</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section class="hero">
        ...
        <div class="container">
            ...
            <div class="hero-cta">
                <a href="#form" class="btn btn-primary btn-lg glow-primary">Get Your Website Audit</a>
                <a href="/contact-us" class="btn btn-outline btn-lg glow-primary">Book a Call</a>
            </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-left">
                    <span class="footer-text">&copy; {{ date('Y') }}, Hardywork Inc. All Rights Reserved. Trusted by
                        businesses
                        everywhere.</span>
                </div>
